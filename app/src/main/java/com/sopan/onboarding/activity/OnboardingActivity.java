...
import com.sopan.onboarding.adapter.OnboardingAdapter;
import com.sopan.onboarding.utils.OnboardingCard;
import com.sopan.onboarding.utils.ShadowTransformer;
import com.sopan.onboarding.views.CircleIndicatorView;
import com.sopan.onboarding.views.FlowingGradientClass;
...
public abstract class OnboardingActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private OnboardingAdapter onboarderAdapter;
    ...
    public void setOnboardPages(List<OnboardingCard> pages) {
        ...
        this.pages = pages;
        onboarderAdapter = new OnboardingAdapter(pages, getSupportFragmentManager(), dpToPixels(0, this), typeface);
